#!/usr/bin/env python3
"""
base_views.py -- 列出多维表格数据表的所有视图

用法:
    python3 base_views.py --app base_token_or_url --table table_id
"""
import sys, os
...
def main():
    parser = argparse.ArgumentParser(description="列出数据表的所有视图")
    ...
    result = client.base_list_views(app_token, table_id)
    print_json(result)
