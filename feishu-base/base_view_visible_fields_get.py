#!/usr/bin/env python3
"""
base_view_visible_fields_get.py -- 获取视图可见字段配置

用法:
    python3 base_view_visible_fields_get.py --app base_token_or_url --table table_id --view view_id
"""
import sys, os
...
def main():
    parser = argparse.ArgumentParser(description="获取视图可见字段配置")
    ...
    result = client.base_get_view_visible_fields(app_token, table_id, args.view)
    print_json(result)
