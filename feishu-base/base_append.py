#!/usr/bin/env python3
"""
base_append.py -- 向多维表格追加记录
用法: python3 base_append.py --app base_token_or_url --table table_id --fields '{"字段名": "值"}'
       python3 base_append.py --app base_token_or_url --table table_id --fields-file record.json
"""
import sys, os
...
def main():
    parser = argparse.ArgumentParser(description="向多维表格追加记录")
    ...
    confirm_action_or_exit("base_append", "确认向数据表追加记录?", yes=args.yes)
    ...
    result = client.base_create_record(app_token, table_id, fields)
