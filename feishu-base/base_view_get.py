#!/usr/bin/env python3
"""
base_view_get.py -- 获取单个视图详情

用法:
    python3 base_view_get.py --app base_token_or_url --table table_id --view view_id_or_name
"""
import sys, os
...
def main():
    parser = argparse.ArgumentParser(description="获取单个视图详情")
    ...
    result = client.base_get_view(app_token, table_id, args.view)
    print_json(result)
